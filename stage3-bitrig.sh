...
### this is an attempt by me to slowly add in the rlibs until I started hitting link errors...
...
### this is the full link command that gets executed...
...
${CXX} ${CXXFLAGS} -o stage3-bitrig/bin/rustc stage2-linux/driver.o ${RUST_DEPS} -L./stage1-bitrig/libs/llvm -L./stage1-bitrig/libs ${SUP_LIBS} ${LLVM_LIBS} -v
