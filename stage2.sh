...
linux_build(){
  ...
  export RUST_FLAGS="-g"
  RUST_LIBS="core libc alloc unicode collections rand std arena regex log fmt_macros serialize term syntax flate time getopts regex test coretest graphviz rustc_back rustc_llvm rbml rustc regex_macros rustc_trans rustc_typeck rustc_borrowck rustc_resolve rustc_driver rustdoc "
